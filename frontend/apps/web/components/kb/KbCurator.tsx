...
export function KbCurator({ chunks }: { chunks: KbChunkView[] }) {
  ...
  return (
    <div className="mt-6 space-y-8">
      {error && (
        <p role="alert" className="rounded border border-danger bg-danger-subtle p-3 text-sm">
          {error}
        </p>
      )}
      ...
      <section>
        ...
        {sources === null && <p className="text-sm text-ink-muted">Đang tải…</p>}
              ...
              >
                ...
                <p className="mt-2 text-sm">
                  ...
                  {s.canActivate ? (
                    ...
                    <span className="text-warn ">chưa có</span>
                  )}
                </p>
                ...
                {!s.canActivate && (
                  <div className="mt-3 grid gap-2 sm:grid-cols-2">
                    ...
                    <label className="text-sm">
                      <span className="text-ink-muted ">Chức danh</span>
                      <input
                        value={d.title}
                        onChange={(e) =>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {!s.canActivate && (
                    <button
                      ...
                      className="rounded border border-border-strong px-3 py-1.5 text-sm disabled:opacity-40 "
                    >
