...
export function FieldCatalog({ node, fieldDefinitions, selectedKeys, onAdd }: FieldCatalogProps) {
  ...
  return <section aria-label="Thêm trường đã đăng ký" className="border-t border-slate-200 pt-3">
    <p className="mb-2 text-[10px] font-semibold uppercase tracking-wide text-slate-500">Thêm trường</p>
